...
FINAL_IMAGE=${DISTDIR}/TEST_UART_SLAVE_1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/TEST_UART_SLAVE_1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
